...
$ACCESSLIB_PRIVATE->dirtyuser        = null;    // Dirty user flag, loaded from DB once per page
...
function accesslib_clear_all_caches($resetcontexts) {
    ...
    $ACCESSLIB_PRIVATE->dirtyuser        = null;
...
function reload_all_capabilities() {
    ...
    $ACCESSLIB_PRIVATE->dirtyuser     = false;
    ...
    */
    ...
    public function reload_if_dirty() {
        ...
        if (CLI_SCRIPT) {
            ...
            if (!isset($ACCESSLIB_PRIVATE->dirtyuser)) {
                $ACCESSLIB_PRIVATE->dirtyuser = get_cache_flag('accesslib/dirtyusers', $USER->id, $changedsince);
            }
        }

        $dirty = false;

        if (!empty($ACCESSLIB_PRIVATE->dirtyuser)) {
            $dirty = true;
        } else {
